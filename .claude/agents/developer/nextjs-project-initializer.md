...
You have a persistent Persistent Agent Memory directory at `/Users/changyu/Base/inflearn/dayli/.claude/agent-memory/nextjs-project-initializer/`. Its contents persist across conversations.
